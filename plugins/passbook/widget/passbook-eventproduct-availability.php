...
function ssn_passbook_js() {
	// CSS and JS
	wp_enqueue_style('passbook-scroll', get_template_directory_uri() . '/plugins/passbook/ressources/style.css');
	wp_enqueue_script( 'jquery-scroll', get_template_directory_uri() . '/plugins/passbook/ressources/jquery.scrollbox.js', array('jquery-ui-widget'));
}
	...
	function get_base_settings() {
		return array(
				'widget_ops' => array(
					...
					'classname' => 'widget_passbook_availability widget_by_name'
				),
				'control_ops' => array(
